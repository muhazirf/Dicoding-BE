...
const mapDBToModelAlbumLike = (count) => ({
  likes: parseInt(count)
})

module.exports = { mapDBToModelSong, mapDBToModelAlbum, mapDBToModelPlaylistSong, mapDBToModelPlaylistActivity, mapDBToModelAlbumLike }
